    ...
    public class Space extends World
    {
        ...
        /** paintStars paints the stars in the world and sets their location and their transparency
         * 
         * @param An integer called count is in the parameters
         * @return Nothing is returned
         */
        ...
        /**
         * addAsteroids adds asteroids to the world in a random number and a random location
         * 
         * @param An integer called count is in the parameters
         * @return Nothing is returned
         */
        private void addAsteriods( int count )
        {
          int x;
          int y;
          for ( int i = 0; i < count; i++ )
