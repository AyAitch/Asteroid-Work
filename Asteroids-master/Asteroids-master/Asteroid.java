...
public class Asteroid extends SmoothMover
{
    ...
    /**
     * setSize sets the size of the asteroid when it gets added to the world
     * @param A integer called size is in the parameters
     * @return Nothing is returned 
     */
    private void setSize(int size)
    {
     ...
     //          called damage.
     /**
      * hit  is the method that will do damage to the asteroids
      * @param An integer called damage is in the parameters
      * @return Nothing is returned
      */
    ...
    /**
     * breakUp is the method that will break up the asteroids into debris and play a explosion sound
     * @param An integer called numBreakUp is in the parameters
     * @return Nothing is returned
     */
